...
public:
  ...
  // Methods to set/retrieve holdability attribute of cursor for ResultSet
  enum cursor_withhold_info { cursor_holdable, cursor_not_holdable, cursor_holdability_disabled };
  cursor_withhold_info get_withhold_attribute(void) const;
  void set_withhold_attribute(const cursor_withhold_info withhold);
...
protected:
  ...
  cursor_withhold_info     m_is_withhold;              // resultset could be holdable, not holdable, or holdability is disabled
};
...
inline Remote_ResultSet::cursor_withhold_info
Remote_ResultSet::get_withhold_attribute (void) const
{
  return m_is_withhold;
}

inline void
Remote_ResultSet::set_withhold_attribute (
	const Remote_ResultSet::cursor_withhold_info withhold)
{
  m_is_withhold = withhold;
}
